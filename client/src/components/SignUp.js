...
function SignUp({ show, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://tech-internship-matchmaker.onrender.com/api/auth/register', {
        email,
        password
      });

      // Log the user in immediately
      const loginRes = await axios.post('https://tech-internship-matchmaker.onrender.com/api/auth/login', {
        email,
        password
      });
